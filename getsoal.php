...
<div class="kakisoal" id="kakisoal">
	<section class="page-section soal-navigation">
		<div class="container1" style="margin-right:-70px; margin-left:-20px;">
			<div >
				 <?php 	if($prev_id>0){ 
					echo "<a href='#' data-id='".$prev_id."' class='get_pic' id='tombol'>"; } ?>
						<button id="btnPrevSoal" style="padding-bottom:5px; padding-top:5px; width:225px" class="btn btn-default btn-prev" data-bind="click: gotoBack">SOAL SEBELUMNYA</button>
					</a>
			</div>
			<?php	if(isset($stu)){ 
			...
			?>
			<div>	<label  class="labele" style="padding-bottom:5px; padding-top:5px; width:225px">
			...
			<div >
					...
					<?php 	$cekragu = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_jawaban where XRagu ='1' and XKodeSoal ='$xkodesoal' and XTokenUjian = '$xtokenujian'  and XUserJawab = '$user'")); 
							if($cekragu>0){ ?>
							<button id="btnSelesai" style="padding-bottom:5px; padding-top:5px; width:225px" class="btn btn-primary btn-end activebutton" data-toggle="modal" data-target="#myModalR">TES SELESAI</button>
					<?php 	} else { ?>  
							<button id="btnSelesai" style="padding-bottom:5px; padding-top:5px; width:225px" class="btn btn-primary btn-end activebutton" data-toggle="modal" data-target="#myModal2">TES SELESAI</button>
					<?php 	} echo "</a>";
							...
							<div class="assent-checkbox">
								<input type="checkbox" data-target="#btnLanjut" id="0-ascb" onClick="document.getElementById('btnLanjut').disabled=false"/>
                                    <label class="assentcb-label" for="0-ascb">
                                        Centang, lalu klik selesai. Jika Yakin Mengakhiri Tes
                                    </label>
							</div>
						</div>
					 </div>
